...
$sql = "INSERT INTO `avis` (`id_avis`, `id_user`, `Avis`, `CptPouceBleu`, `CptPouceRouge`, `CptReport`, `CptEtoile`, `id_commentaire_avis`, `id_lieu`) VALUES ('$id_avis','4','$avis','0','0','0','$etoile','6','$id_lieu')";
...
echo(json_encode([$etoile, $avis, $id_avis]));
